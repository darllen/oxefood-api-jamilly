...
import br.com.ifpe.oxefood.api.cliente.endereco.EnderecoClienteRequest;
...
public class ClienteController {
    ...
    @ApiOperation(value = "Serviço responsável por alterar um cliente referente ao Id passado na URL.")
    @PutMapping("/{id}")
